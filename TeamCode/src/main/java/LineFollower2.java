...
@Autonomous(name="LineFollower1", group="Psionics")
//@Disabled
...
idle();
           ...
           DbgLog.msg(String.format("V1DBG: current postion front left %10d :", robot.leftFrontMotor.getCurrentPosition()));
            ...
            while (opModeIsActive() &&
                ...
                currentLeftPosition2 = robot.leftFrontMotor.getCurrentPosition();
                currentRightPosition2 = robot.rightFrontMotor.getCurrentPosition();
                ...
                if (runtime.milliseconds() - TimeLastDbgMsglogged >= 100.0) {
                    ...
                    telemetry.update();
                    idle();
                    DbgLog.msg(String.format("V1DBG: runtime.milliseconds() - TimeLastDbgMsglogged >= 100.0"));
                    ...
                    telemetry.update();
                    idle();
                    DbgLog.msg(String.format("V1DBG: after millisecond 100 -- false and incriments set"));
                ...
                if ((lastCurrentLeftPosition != currentLeftPosition) || (lastCurrentRightPosition != currentRightPosition)) {
                    ...
                    telemetry.update();
                    idle();
                    DbgLog.msg(String.format("V1DBG: lastCurrentLeftPosition != currentLeftPosition) || (lastCurrentRightPosition != currentRightPosition"));

                    DbgMsglogged = false;
                    lastCurrentLeftPosition = currentLeftPosition;
                    lastCurrentRightPosition = currentRightPosition;

                    lastCurrentLeftPosition2 = currentLeftPosition2;
                    lastCurrentRightPosition2 = currentRightPosition2;

                    telemetry.addData("V1DBG: after run to position", "Complete");
                    telemetry.update();
                    idle();
                    DbgLog.msg(String.format("V1DBG: after current positions reset in last current if loop"));
                }
                ...
                if (DbgMsglogged == false) {
                    ...
                    telemetry.update();
                    idle();
                    DbgLog.msg(String.format("V1DBG: Psionics_Rover : Debug - Currently at %7d :%7d", currentLeftPosition, currentRightPosition));
            ...
            telemetry.update();
            idle();
            DbgLog.msg(String.format("V1DBG: turn off run to position"));
