 ...
 */
@Autonomous(name="Psionics_Autonomous : Non-Powered_Omnis_Side_Red_Center_Vortex", group="Psionics")
//@Disabled
public class Psionics_Autonomous_Non_Powered_Omnis_Side_Red_Center_Vortex extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            FtcRobotControllerActivity.myPsionics_Vision_OpenCV.setRedMode(true);
            ...
            if (doOnce == false) {
                ...
                encoderDriveBack_TwoEnc_Turns(1.0,1.80*(-FRONT_EIGHTH_TURN),1.80*(FRONT_EIGHTH_TURN), STOP_CONDITION.STOP_ON_ANY_FRONT,2.00); //orig. 1.00
                encoderDriveBack_TwoEnc(1.0,-51.0,-51.0, STOP_CONDITION.STOP_ON_ANY_FRONT,5.00); //orig. 2.25
                ...
                encoderDriveBack_TwoEnc_Turns(1.0,1.35*(FRONT_EIGHTH_TURN),1.35*(-FRONT_EIGHTH_TURN), STOP_CONDITION.STOP_ON_FRONT_MOTORS,1.50); //orig.1.0
    ...
    public void getToLine2() throws InterruptedException{
        ...
        //while(lineState != lineState_LEFT_FRONT && lineState != lineState_RIGHT_FRONT) {
        //encoderDriveFront_TwoEnc_Short_UntilLine_TwoLineTarget(DRIVE_SPEED_SHORT_UNTIL_LINE,-24.0,-24.0,FRONT_TWO_ENCODER_SHORT_RIGHT_SPEED_COMPENSATION_FRONT_STRAIGHT_THREE,lineState_LEFT_FRONT,lineState_RIGHT_FRONT,STOP_CONDITION.STOP_ON_ANY_FRONT,3.60);
        encoderDriveBack_TwoEnc(1.0,-60.0,-60.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,1.28);
        encoderDriveBack_TwoEnc_Three_Line_Target(0.3,-15.0,-15.0,lineState_LEFT_SENSOR,lineState_RIGHT_SENSOR,lineState_LEFT_AND_RIGHT_SENSORS,STOP_CONDITION.STOP_ON_FRONT_MOTORS,1.28);
        sleep(50);
        setLineStateSide();
        while(lineState == lineState_NONE) {
            encoderDriveBack_TwoEnc_Three_Line_Target(0.2,1.0,1.0,lineState_LEFT_SENSOR,lineState_RIGHT_SENSOR,lineState_LEFT_AND_RIGHT_SENSORS,STOP_CONDITION.STOP_ON_FRONT_MOTORS,0.25);
    ...
    public void triggerBeacon(double timeoutS) throws InterruptedException {
        ...
        if(beaconColorState == 1.0) {
            while(opModeIsActive() && runtime.seconds() < timeoutS/2) {
                robot.backRightActuator.setPosition(robot.BACKRIGHTACTUATOR_HOME + robot.ACTUATORS_BUTTON_PUSH_DISTANCE);
            }
            robot.backRightActuator.setPosition(robot.BACKRIGHTACTUATOR_HOME);
        }
