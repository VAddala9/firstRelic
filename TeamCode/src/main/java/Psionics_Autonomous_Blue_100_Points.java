 ...
 */
@Autonomous(name="Psionics_Autonomous_Blue : 60P", group="Psionics")
//@Disabled
public class Psionics_Autonomous_Blue_100_Points extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (doOnce == false) {
                ...
                encoderDriveBack_TwoEnc(DRIVE_SPEED,-15.0,-15.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,0.80); //orig. 1.00

                flickerDoFullRotation(FLICKER_ONE_REVOLUTION,FLICKER_SPEED,1.0); //orig. 3.0
                intakeTimedDrive(1,1.0);
                sleep(500);
                flickerDoFullRotation(FLICKER_ONE_REVOLUTION,FLICKER_SPEED,1.0); //orig. 3.0

                encoderDriveBack_TwoEnc(TURN_SPEED,0.75*(FRONT_EIGHTH_TURN),0.75*(-FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_ANY_FRONT,1.0);
                encoderDriveBack_TwoEnc(TURN_SPEED,0.75*(FRONT_EIGHTH_TURN),0.75*(-FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_ANY_FRONT,1.0);
                encoderDriveBack_TwoEnc(DRIVE_SPEED,-51.0,-51.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.50); //orig. 45.0
                encoderDriveBack_TwoEnc(TURN_SPEED,0.75*(-FRONT_EIGHTH_TURN),0.75*(FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_ANY_FRONT,1.0);
                encoderDriveBack_TwoEnc(TURN_SPEED,0.75*(-FRONT_EIGHTH_TURN),0.75*(FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_ANY_FRONT,1.0);

                getToLine();

                encoderDriveFront_TwoEnc_Short(DRIVE_SPEED_SHORT,-6.0,-6.0,FRONT_TWO_ENCODER_SHORT_RIGHT_SPEED_COMPENSATION_FRONT_STRAIGHT_THREE,STOP_CONDITION.STOP_ON_ANY_FRONT,1.20);
                encoderDriveBack_TwoEnc(TURN_SPEED,1.46*(-FRONT_QUARTER_TURN),1.46*(FRONT_QUARTER_TURN),STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.00); //orig. 3.72

                positionRobotForBeacon();

                /*encoderDriveBack_TwoEnc(DRIVE_SPEED,-26.0,-26.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,1.45);
                ...
                encoderDriveBack_TwoEnc(TURN_SPEED,FRONT_EIGHTH_TURN,-FRONT_EIGHTH_TURN,STOP_CONDITION.STOP_ON_ANY_FRONT,1.0);
                encoderDriveBack_TwoEnc(DRIVE_SPEED,-42.0,-42.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.27);
                encoderDriveBack_TwoEnc(TURN_SPEED,-FRONT_EIGHTH_TURN,FRONT_EIGHTH_TURN,STOP_CONDITION.STOP_ON_ANY_FRONT,1.0);
                encoderDriveBack_TwoEnc(TURN_SPEED,1.25*(-FRONT_QUARTER_TURN),1.25*(FRONT_QUARTER_TURN),STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.40);*/
                ...
                //encoderDriveBack_TwoEnc(DRIVE_SPEED,-29.0,-29.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.0);

                //encoderDriveBack_TwoEnc(TURN_SPEED,1.46*1.25*(FRONT_EIGHTH_TURN),1.46*1.25*(-FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.0);
                //encoderDriveBack_TwoEnc(DRIVE_SPEED,-29.0,-29.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.5);
                //encoderDriveBack_TwoEnc(DRIVE_SPEED,-30.0,-30.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.5);
                //encoderDriveBack_TwoEnc(TURN_SPEED,1.20*(-FRONT_EIGHTH_TURN),1.20*(FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.0);
                //encoderDriveBack_TwoEnc(DRIVE_SPEED,-6.00,-6.00,STOP_CONDITION.STOP_ON_FRONT_MOTORS,2.0);
                //encoderDriveBack_TwoEnc(TURN_SPEED,3.25*(-FRONT_EIGHTH_TURN),3.25*(FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_FRONT_MOTORS,3.0);
                ...
                //encoderDriveBack_TwoEnc(DRIVE_SPEED,-30.0,-30.0,STOP_CONDITION.STOP_ON_FRONT_MOTORS,1.45);

                /*encoderDriveBack_TwoEnc(TURN_SPEED,FRONT_EIGHTH_TURN,-FRONT_EIGHTH_TURN,STOP_CONDITION.STOP_ON_FRONT_MOTORS,1.0);
    ...
    public void triggerLeftButton() throws InterruptedException {
            ...
            encoderDriveBack_TwoEnc(TURN_SPEED,1.1*(-FRONT_EIGHTH_TURN),1.1*(FRONT_EIGHTH_TURN),STOP_CONDITION.STOP_ON_ANY_FRONT,1.0);
            setLineState();
            /*telemetry.addData("Beacon state : ", beaconColorState);
            telemetry.addData("Line state : ", lineState);
            telemetry.addData("Beacon Start : ", beaconStart);
    ...
    public void triggerRightButton() throws InterruptedException {
        robot.buttonPusher.setPosition(0.42);
        encoderDriveBack_TwoEnc(TURN_SPEED, 1.1 * (FRONT_EIGHTH_TURN), 1.1 * (-FRONT_EIGHTH_TURN), STOP_CONDITION.STOP_ON_ANY_FRONT, 1.0); //orig. sixteenth
        setLineState();
        /*telemetry.addData("Beacon state : ", beaconColorState);
        telemetry.addData("Line state : ", lineState);
        telemetry.addData("Beacon Start : ", beaconStart);
    ...
    public void setDistanceSensorState() throws InterruptedException {
        double sensorState1;
        double sensorState2;
        double sensorState3;

        sensorState1 = robot.beaconDistanceSensor1.getRawLightDetected();
        sensorState2 = robot.beaconDistanceSensor2.getRawLightDetected();
        sensorState3 = robot.beaconDistanceSensor3.getRawLightDetected();
        sleep(50);
        sensorState1 += robot.beaconDistanceSensor1.getRawLightDetected();
        sensorState2 += robot.beaconDistanceSensor2.getRawLightDetected();
        sensorState3 += robot.beaconDistanceSensor3.getRawLightDetected();
        ...
        distanceSensorState1 = sensorState1 / 3;
        distanceSensorState2 = sensorState2 / 3;
        distanceSensorState3 = sensorState3 / 3;
    }
    ...
    public void straightenToLineLeft() throws InterruptedException {
        ...
        encoderDriveFront_TwoEnc_Short(DRIVE_SPEED_SHORT, -2.0, -2.0, FRONT_TWO_ENCODER_SHORT_RIGHT_SPEED_COMPENSATION_FRONT_STRAIGHT_THREE, STOP_CONDITION.STOP_ON_ANY_FRONT, 0.38);
        setLineState();
        while(lineState != lineState_RIGHT && count < iterationMax) {
            ...
            if(lineState == lineState_RIGHT_FRONT) {
                encoderDriveFront_TwoEnc_Short(DRIVE_SPEED_SHORT, iterationBackSize, iterationBackSize, FRONT_TWO_ENCODER_SHORT_RIGHT_SPEED_COMPENSATION_FRONT_STRAIGHT_THREE, STOP_CONDITION.STOP_ON_ANY_FRONT, 0.38);
                setLineState();
            }
            count++;
        }
        ...
        while (distanceSensorState1 < 0.05 && distanceSensorState2 < 0.1 && distanceSensorState3 < 0.07) {
            encoderDriveFront_TwoEnc_Short(DRIVE_SPEED_SHORT, 1.0, 1.0, FRONT_TWO_ENCODER_SHORT_RIGHT_SPEED_COMPENSATION_FRONT_STRAIGHT_THREE, STOP_CONDITION.STOP_ON_ANY_FRONT, 0.30);
            //count++;
            /*if(count == 6) {
                encoderDriveBack_TwoEnc(TURN_SPEED,iterationTurnSize,-iterationTurnSize,STOP_CONDITION.STOP_ON_ANY_FRONT,1.5);
                count = 0;
    ...
    public void straightenToLineRight() throws InterruptedException {
        ...
        encoderDriveFront_TwoEnc_Short(DRIVE_SPEED_SHORT, -3.8, -3.8, FRONT_TWO_ENCODER_SHORT_RIGHT_SPEED_COMPENSATION_FRONT_STRAIGHT_THREE, STOP_CONDITION.STOP_ON_ANY_FRONT, 0.38); //orig. 4.0
        setLineState();
        ...
        setDistanceSensorState();
        while (distanceSensorState1 < 0.05 && distanceSensorState2 < 0.1 && distanceSensorState3 < 0.07) {
            encoderDriveFront_TwoEnc_Short(DRIVE_SPEED_SHORT, 3.8, 3.8, FRONT_TWO_ENCODER_SHORT_RIGHT_SPEED_COMPENSATION_FRONT_STRAIGHT_THREE, STOP_CONDITION.STOP_ON_ANY_FRONT, 0.50);
            encoderDriveBack_TwoEnc(TURN_SPEED,1.2*1.5*0.1875*(iterationTurnSize),1.2*1.5*0.1875*(-iterationTurnSize),STOP_CONDITION.STOP_ON_ANY_FRONT,0.50); //orig 0.125
