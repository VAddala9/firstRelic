...
@Autonomous(name="Auto_R_timer_noWall_noLine", group="Psionics")
//@Disabled
public class Auto_R_timer_noWall_noLine extends LinearOpMode {
	...
	//move forward
       ...
       // robot.flickerMotor.setPower(0);
        ...
        back_left_motor_pwr = -0.25;
        back_right_motor_pwr = -0.25;
        front_left_motor_pwr = -0.25;
        front_right_motor_pwr = -0.25;
	time_out =1.0;
...
//rotate right
       /* back_left_motor_pwr = 0.125;
        ...
        back_left_motor_pwr = 0.5;
        back_right_motor_pwr =-0.5;
        front_left_motor_pwr = 0.5;
        front_right_motor_pwr = -0.5;
	time_out = 3.5;
        timedDrive(back_left_motor_pwr, back_right_motor_pwr, front_left_motor_pwr, front_right_motor_pwr, time_out);
        robot.flickerMotor.setPower(0);
