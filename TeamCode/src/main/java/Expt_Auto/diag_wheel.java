...
@Autonomous(name="diag_wheel", group="Psionics")
//@Disabled
public class diag_wheel extends LinearOpMode {
	...
	//move forward
        ...
        back_right_motor_pwr = 0;
        front_left_motor_pwr = 0;
        front_right_motor_pwr = 0;
	time_out =2.0;
