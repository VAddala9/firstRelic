 ...
 */
@Autonomous(name="Psionics_Autonomous : Non-Powered_Omnis_Side_Blue_Center_Vortex", group="Psionics")
//@Disabled
public class Psionics_Autonomous_Non_Powered_Omnis_Side_Blue_Center_Vortex extends LinearOpMode {
